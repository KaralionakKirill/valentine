...
class ConfettiSystem {
    ...
    particles: Particle[] = [];
    colors = ['#ff5f9e', '#FFD9E3', '#FFFBFC', '#9C404E', '#FFD700', '#FF69B4']; // Pink palette + Gold/HotPink
    isRunning = false;
    ...
    burst(x: number, y: number, count = 100) {
        if (!this.canvas) return;
...
function moveButtonRandomly(btn: HTMLElement) {
